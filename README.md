# inhaled-RIF-popPK
Population-level ODE model for the comparison of an oral dose and inhaled dose of the anti-TB medication rifampin. Able to be run quickly as-is - modeling parameters have been scaled down for example runs.
